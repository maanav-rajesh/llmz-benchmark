...
//     let selIndex = -1;
//     const reservedLines =
//       quickReplies.length + (quickReplies.length > 0 ? 2 : 1); // +1 for hint line if we have replies
...
//           stdout.write(
//             chalk.cyan.bold("❯ ") + chalk.cyan.inverse(`  ${quickReplies[i]}  `)
//           );
//         } else {
//           // Normal button style
//           stdout.write(
//             chalk.gray("  ") + chalk.bgBlack.gray(`[ ${quickReplies[i]} ]`)
//           );
//         }
