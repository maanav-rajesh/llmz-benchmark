...
//         ...this.renderers.map((r) => r.component),
//       ],
...
//       console.warn(
//         chalk.yellow(
//           "⚠️ Too many turns, stopping the chat to prevent infinite loop"
//         )
//       );
//       return false;
//     }
...
//   public hasExited(
//     this: this
//   ): this is this & { status: IterationStatuses.ExitSuccess } {
//     return this.status?.type === "exit_success";
//   }

//   public hasExitedWith<R>(
//     this: this,
//     exit: Exit<R>
//   ): this is { status: IterationStatuses.ExitSuccess<R> } & this {
//     return (
//       this.status?.type === "exit_success" &&
...
//         role: "user",
//         content: "[silence] (user did not answer)",
//       });
//     }
//   };
...
//           console.log(
//             chalk.bold("🤖 Agent: ") +
//               chalk.gray("<unknown component> " + JSON.stringify(child))
//           );
//         }
//       }
//     }
...
//     T extends Component,
//     Props extends Record<string, any> = T extends Component
//       ? T["propsType"]
//       : never
//   >(
//     component: T,
//     render: (component: RenderedComponent<Props>) => Promise<void>
//   ): void {
//     if (
//       this.renderers.some(
//         (r) => r.component.definition.name === component.definition.name
//       )
//     ) {
//       throw new Error(
//         `Component ${component.definition.name} is already registered`
//       );
//     }
